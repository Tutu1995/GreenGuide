	...
	<body>
		...
		-->
            ...
            <div class="container-fluid">      
				...
				<div class="link">
						<br>
		            	<p>Check and Edit your reviews in <a href="http://www.lovegreenguide.com/profile.php" style="text-decoration: underline;">My Profile</a>.</p>
		            	<p>Explore all the reviews in <a href="http://www.lovegreenguide.com/map.php" style="text-decoration: underline;">Explore Reviews on a Map</a>.</p>
						<br><br>
				</div>
			</div>
            <?php	 
