<?php  
		 ...
		 // $del_token = md5(uniqid(rand(),TRUE));
...
<body>
				...
				?>
                 ...
                 <header id="header">	                                        
                  ...
                  -->
                  <div class="container text-center"><p class="text-primary">最新点评－编辑或删除点评</p></div>
...
<script type="text/javascript">
	...
	count_c.innerHTML=all.length+" 点评"
	...
	*/
	...
	function setList(page){
			...
			for (var i = 0; i < all_page.length; i++) {
				...
				var r_info= "<h4 style='margin:0 0 5px 0;color:"+ status_color +";'>"+r_status+"</h4>" + "公司名称: " + all_page[i].review.company +"<br/>" + "地址: "+ all_page[i].review.address +"<br/>" + "城市: "+all_page[i].review.city+"<br/>" + "产业类别: " +all_page[i].review.industry+"<br/>"+ "产品名称: " +all_page[i].review.product+ "<br/>"+"评分: "+all_page[i].review.rating+"<br/>" + "<img src='"+ pic[pic_rate] +"' width='228' height='30' /><br/>"+ "内容: "+all_page[i].review.review +"<br/>"+ "环境关注点: "+all_page[i].review.water+" " +all_page[i].review.air+" "+all_page[i].review.waste+" "+all_page[i].review.land+" "+all_page[i].review.living+" "+all_page[i].review.other+"<br/>"+"相关新闻、视频或链接: "+all_page[i].review.news+"<br/>"+ "环保局官方信息: " +all_page[i].review.epa+ "<br/>"+ "实验数据: " +all_page[i].review.measure+ "<br/>"+"提交时间: "+all_page[i].review.time+"<br/>";
