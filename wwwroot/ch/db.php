...
$db=new PDO("mysql:dbname=acsm_57be34e339d28c1;host=ap-cdbr-azure-east-c.cloudapp.net;charset=utf8","b0eec879a42eb2","62e1b263");
...
function is_password_correct($name, $password){
		...
		try{
			$db=new PDO("mysql:dbname=acsm_57be34e339d28c1;host=ap-cdbr-azure-east-c.cloudapp.net","b0eec879a42eb2","62e1b263");
			$db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			//$name= $db->quote($name);
...
function ensure_logged_in(){
	if(!isset($_SESSION["name"])){
		redirect("http://www.lovegreenguide.com/ch/user.php","请输入帐号密码登录");
	}
}
