				 ...
				 <div class="container-fluid"> 
                  		  <form class="form-inline" role="form">
              							  <div class="form-group">
              							    <label for="go_location">在下拉菜单中点击公司名称或所在城市后，公司相关信息将自动代入 </label>
              							    <input type="text" class="form-control input-sm" id="suggestId_2" size="50" placeholder="公司名称 或 （地点+公司名称）">
              							  </div>
          						  ...
          						  <form action="map_go.php" class="form-inline" role="form">
              							  <div class="form-group">
                  							    <label for="industry">输入产业类别或产品名称，点击“找点评”进行地图搜索 </label>
                  							    <input name="industry" type="text" class="form-control input-sm" size="30" placeholder="产业类别">
              							  </div>
              							  <div class="form-group">
                  							  	<label class="sr-only" for="product">product</label>
                  							    <input name="product" type="text" class="form-control input-sm" size="30" placeholder="产品名称">
              							  </div>
