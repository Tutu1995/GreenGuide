...
<body style="height: auto; overflow:hidden;">
        ...
        <div class="container-fluid">           
                   ...
                   <p>Hover a company brief and check out its location on the map. Click a company brief and check out all its reviews.</p> 
                   <!--
                   <div id="keyword"></div>
                   <div class="inline">
	                   <div id="fixed">
...
<?php  
  ...
  <script type="text/javascript">
	...
	document.getElementById("keyword").innerHTML= "Search for : "+s_company+" "+s_location;
