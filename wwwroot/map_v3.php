...
<body>
      <div class="wrapper">
                  ...
                  <div id="mycity"> 
		                 ...
		                 -->
		                  <div id="r-result">Please enter key words and search on the map. ex. company name or location : <input type="text" id="suggestId_2" size="64" placeholder="Company Name or related keyword ex. location"  /></div><br/>
