...
-->
                  ...
                  <div class="container-fluid"> 
						  ...
						  <form action="map_go.php" class="form-inline" role="form">
							  <div class="form-group">
							    <label for="industry">Please key in the industry or product you'd like to search on the map and click "Submit".</label>
							    <input id="industry" name="industry" type="text" class="form-control input-sm" size="30" placeholder="Industry">
							  </div>
							  <div class="form-group">
							  	<label class="sr-only" for="product">product</label>
							    <input id="product" name="product" type="text" class="form-control input-sm" size="30" placeholder="Product">
							  </div>
