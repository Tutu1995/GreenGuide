				 ...
				 <div class="container-fluid"> 
                  		  <form class="form-inline" role="form">
              							  <div class="form-group">
              							    ...
              							    <input type="text" class="form-control input-sm" id="suggestId_2" size="40" placeholder="Company Name or (Location + Company Name)">
              							  </div>
          						  ...
          						  <form action="map_go.php" class="form-inline" role="form">
              							  <div class="form-group">
                  							    <label for="industry">Please key in the industry or product you'd like to search on the map and click "go".</label>
