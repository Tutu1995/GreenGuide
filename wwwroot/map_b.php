...
<body>
                  ...
                  <div class="container-fluid text-center"> 
                  		  <div class="form-group">
						      <label class="col-sm-9 control-label">Please search the city or company in the dropdown menu and click it. System'll bring the city or company location on the map</label>
						      <div class="col-sm-3">
						        <input class="form-control input-sm" id="focusedInput" type="text" id="suggestId_2" value="Company Name or (Location + Company Name)">
						      </div>
						  </div>
                  		  ...
                  		  <form id="s_product"	action="map_go.php">
                                Please key in the industry or product you'd like to search on the map and click "go". <input name="industry" type="text" size="35" placeholder="Industry" /> 
                                <input name="product" type="text" size="35" placeholder="Product" />  
                                <input type="submit" value="go" />  
                          </form>

                          <form id="s_product" action="map_go.php" >
                                                              <div class="form-group">
                                                              	  <label class="col-sm-6 control-label">Please key in the industry or product you'd like to search on the map and click "go".</label>
                                                                
	                                                                  <div class="col-sm-2">
	                                                                  		<input class="form-control input-sm col-sm-2" name="industry" type="text"  placeholder="Industry">
                                                                 	  </div>
                                                              	  
	                                                                  <div class="col-sm-2">
	                                                                  		<input class="form-control input-sm col-sm-2" name="product" type="text"  placeholder="Product">
                                                                	  </div>
                                                              </div>
