<?php  
		  ...
		  if(isset($_SESSION["review_id"])){
		  		...
		  		header("Location: http://greenguide.azurewebsites.net/profile.php");
		  }
		  try{
		...
		-->
            ...
            <div class="main">
                  ...
                  <div>
		                  ...
		                  <div id="s_image">
				                  <?php
								  $show=$con->query("select * from image where review_id= $review_id ");
								  foreach($show as $row)
								  {
									  
									  echo'<img height="190" width="190" src="data:image;base64,'.$row[1].'"> ';					  
								  }	
								  ?>
		                  </div><br/>
		          </div>
			...
			<div class="link">
					<br>
	            	<p>Check and Edit your reviews in <a href="http://greenguide.azurewebsites.net/profile.php" style="text-decoration: underline;">My Profile</a>.</p>
	            	<p>Explore all the reviews in <a href="http://greenguide.azurewebsites.net/map.php" style="text-decoration: underline;">Explore Reviews on a Map</a>.</p>
					<br><br>
			</div>
